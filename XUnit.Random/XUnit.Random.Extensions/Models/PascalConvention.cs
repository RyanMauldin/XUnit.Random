...
{
    /// <summary>
    /// <see cref="LowerConvention"/> is responsible for converting a string value to its Pascal case form.
    /// </summary>
    public class PascalConvention : IConvention
    {
        /// <summary>
        /// Default comparer.
        /// </summary>
        ...
        /// software development for class method names. Pascal case is synonymous with Camel case, except the first letter
        /// is capitalized. See <a href="https://en.wikipedia.org/wiki/Camel_case">wikipedia#camel</a>.
            ...
            foreach (var word in words)
            {
                ...
                foreach (var wordCharacter in word)
                {
                    ...
                    if (isUpper)
                    {
                        ...
                        // Append the uppercase character and move on.
                        subWordBuilder.Append(wordCharacter);
                        continue;
                    }
